...
public sealed record EligibilityDeclineReason(string Code, string Explanation)
{
        ...
        decimal maximumRatio)
    {
        return new(
            ...
            $"Loan to value {loanToValue} exceeds the {maximumRatio:P0} maximum for loans of £1 million or more.");
    }
        ...
        int requiredMinimum)
    {
        return new(
            ...
            $"Credit score {applicantCreditScore} is below the minimum of {requiredMinimum} for loans of £1 million or more.");
    }
        ...
        decimal maximumRatio)
    {
        return new(
            ...
            $"Loan to value {loanToValue} is at or above the {maximumRatio:P0} maximum for loans under £1 million.");
    }
